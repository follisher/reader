...
class _CatalogSheetState extends State<CatalogSheet>
  ...
  /// 卡片主体：书签显示正文摘要；划线显示波浪线文字；评论显示引用原文 + 评论正文。
  Widget _noteBody(ReaderLabels labels, _Note n) {
    ...
    return Text(
      n.text.isEmpty ? labels.bookmarkTab : n.text,
      maxLines: 3,
      overflow: TextOverflow.ellipsis,
      style: _sans(size: 15, height: 1.5).copyWith(
        ...
        color: n.text.isNotEmpty ? _text.withValues(alpha: 0.9) : _sub,
      ),
    );
  }
